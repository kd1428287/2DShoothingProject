...
void RenderManager::DrawQueue(std::vector<ObjectData>& queue_)
{
    ...
    std::stable_sort(queue_.begin(), queue_.end(),
        [](const ObjectData& a, const ObjectData& b) {
            ...
            // priority Ç™ìØÇ∂Ç»ÇÁ footPosition (Yç¿ïW) Ç≈ëOå„ä÷åWÇåàÇﬂÇÈ
    ...
    // â¡éZï`âÊ (Add) - ã´äE iterator à»ç~Ç… true Ç™èWÇ‹Ç¡ÇƒÇ¢ÇÈ
    if (it != queue_.end())
    {
        ...
        D3D.SetBlendState(BlendMode::Alpha); // èÛë‘ÇñﬂÇ∑
    }
